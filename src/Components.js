...
export const ButtonGenerator = (props) => {
  ...
  } else return (<Button className='nextButton' onClick={props.clickEndGame} color='danger'>Finish Game</Button>)
}
  ...
  return (
    <Col xs='auto'>
      <Jumbotron className='startEndGameBox'>
        ...
        <br />
        <Button className='endButton' onClick={() => { props.reset(); props.click() }} color='danger'>Play Again?</Button>
      </Jumbotron>
    </Col>
  )
}
